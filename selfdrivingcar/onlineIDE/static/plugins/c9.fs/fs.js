...
define(function(require, exports, module) {
    ...
    function main(options, imports, register) {
        ...
        var vfs = require("plugins/se.rwth.vfs/vfs");
        ...
        function load() {
			...
			c9.setStatus(0 | c9.NETWORK | c9.STORAGE | c9.PROCESS);
        }
        ...
        plugin.freezePublicAPI({
             ...
             * 
             */
            readFileWithMetadata: wrap("readFile", vfs.readFileWithMetadata),
