...
var Credentials = /** @class */ (function (_super) {
    ...
    Credentials.prototype.setHTMLElements = function () {
    ...
    Credentials.prototype.addEventListeners = function () {
    };
    Credentials.prototype.show = function () {
        this.$container.show();
        this.emit("show");
    };
    Credentials.prototype.hide = function () {
        this.$container.hide();
        this.emit("hide");
    };
    ...
    Credentials.prototype.areAvailable = function () {
        var username = this.getUsername();
        var password = this.getPassword();
        return username.length > 0 && password.length > 0;
    };
    Credentials.prototype.onSubmitClick = function () {
    };
    Credentials.prototype.onCancelClick = function () {
    };
    return Credentials;
}(module_1.Module));
