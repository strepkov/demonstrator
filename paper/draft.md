...
**(R3) Work on any operating system and without installation:** 
All examined tutorials have web-implementation and work without installation, except the Swift tutorial, which has only iOS realization.  Simulink does not work online; MATLAB the basic
